#!/usr/bin/env node
// inshellisense/scripts/gen-claude-spec.mjs
//
// Claude Code の CLI リファレンス（マークダウン）から
// inshellisense 用の Fig 互換スペック (specs/claude.js) を生成する。
//
// 使い方:
//   node inshellisense/scripts/gen-claude-spec.mjs
//   node inshellisense/scripts/gen-claude-spec.mjs --input /path/to/cli-reference.md
//   node inshellisense/scripts/gen-claude-spec.mjs --output /tmp/claude.js
//   node inshellisense/scripts/gen-claude-spec.mjs --url https://example.com/cli-reference.md
//
...
function emitSpec(spec, sourceUrl) {
  ...
  return `// AUTO-GENERATED by inshellisense/scripts/gen-claude-spec.mjs
// Source: ${sourceUrl}
